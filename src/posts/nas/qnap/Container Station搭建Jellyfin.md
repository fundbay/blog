...
services:
  jellyfin:
    ...
    volumes:
      ...
      - /share/CACHEDEV3_DATA/Movies:/media
    ports:
      - 8096:8096
      - 8920:8920
    devices:
    ...
    extra_hosts:
      ...
      - 'image.tmdb.org:143.204.231.87'
      - 'image.tmdb.org:143.204.231.16'
      - 'image.tmdb.org:143.204.231.115'
      - 'image.tmdb.org:143.204.231.27'
      - 'www.themoviedb.org:99.86.91.103'
      - 'www.themoviedb.org:99.86.91.3'
      - 'www.themoviedb.org:99.86.91.99'
      - 'www.themoviedb.org:99.86.91.101'
    restart: always
```
